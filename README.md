...
`hello@snappytales.com` using the [Resend](https://resend.com) email API. Configure the following environment variables in a
...
CONTACT_TO_EMAIL="hello@snappytales.com"
```
