...
export default function RetainerEngagement() {
	...
	const whenToChoose = [
		"Regular email campaigns and newsletters",
		"Ongoing SEO or marketing initiatives",
		"Monthly design and development needs",
		"Continuous support for existing business relationships",
	];

	const benefits = [
		"Predictable monthly costs",
		"Dedicated hours and priority access",
		"Long-term partnership and strategy alignment",
	];

	return (
		<section
			ref={sectionRef}
			className="relative w-full py-20 px-4 md:px-12 lg:px-20 bg-gray-50 dark:bg-black transition-colors duration-300"
		>
			<motion.div
				initial={{ opacity: 0 }}
			...
			>
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
					...
					>
						...
						>
							<Image
								src="/images/pricing/retainer-engagement.png"
								alt="Retainer engagement mockup"
								fill
					...
					>
						...
						<motion.p variants={itemVariants} className="text-gray-600 dark:text-gray-300 text-lg">
							Get the peace of mind that comes with having a specialist on
							retainer to address your needs, month after month.
						</motion.p>
