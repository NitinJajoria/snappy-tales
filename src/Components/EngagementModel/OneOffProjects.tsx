...
export default function OneOffProjects() {
	...
	const whenToChoose = [
		...
		"Setting up a landing page or microsite",
		"Designing and developing email templates",
		"Handling seasonal or ad-hoc campaigns",
	];
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
					...
					>
						...
						<motion.p variants={itemVariants} className="text-gray-600 dark:text-gray-300 text-lg">
							Ideal for standalone tasks, e.g., email templates, website
							development, automation, CRM setup, or SEO building.
						</motion.p>
						...
						>
							...
							<div className="flex items-baseline gap-2">
								...
								<span className="text-gray-400 dark:text-gray-500 text-sm">/ project</span>
							</div>
						</motion.div>
					...
					<motion.div
						...
						className="w-full relative flex flex-col gap-6 items-center"
					>
						<motion.div
						...
						>
							<Image
								src="/images/pricing/one-off-project.png"
								alt="Project mockup"
								fill
