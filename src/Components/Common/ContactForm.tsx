                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                        ...
                        >
                            <div>
                                ...
                                <p className="text-xl font-bold opacity-70 max-w-md leading-relaxed">
                                    Ready to transform your business? Let's get you
                                    started with the perfect solution tailored for your needs.
                                </p>
                            </div>
                        ...
                        <motion.div variants={itemVariants} className="bg-white/20 backdrop-blur-md rounded-[3rem] p-8 md:p-12 border border-black/5 shadow-inner">
                            <form className="space-y-10">
                                ...
                                <Button variant="dark" className="px-12 py-6 text-xl flex items-center justify-center gap-3 w-full md:w-auto shadow-2xl">
                                    SEND MESSAGE
                                    <Mail size={24} />
                                </Button>
                            </form>
